...
//		label.setHorizontalTextPosition(JLabel.CENTER); This does nothing
//		label.setVerticalTextPosition(JLabel.TOP); Or this

		//At least this works
		JFrame window = new JFrame("The Guessing Game");
